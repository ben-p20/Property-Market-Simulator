...
1. Switching to a log-linear model: Instead of predicting raw price directly, the model can be configured to predict the logarithm of an attributes value which prevents the output from being a negative number
